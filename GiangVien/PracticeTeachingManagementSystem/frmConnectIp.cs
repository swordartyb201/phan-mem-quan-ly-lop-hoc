...
namespace PracticeTeachingManagementSystem
{
    public partial class frmConnectIp : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (true)
                {
                    ...
                    setting.SaveConnectionString("PracticeTeachingManagementSystem.Properties.Settings.PTMSConnectionString4", connectionString);
        ...
        {
            string conStr = ConfigurationManager.ConnectionStrings["PracticeTeachingManagementSystem.Properties.Settings.PTMSConnectionString4"].ToString();
